...
class Dtdr_Load{
    ...
    public function _init(){
        ...
        if( !class_exists('\DroitDark\Includes\Dtdr_Features')){
            delete_option('__validate_author_dtdrdark_keys__');
            delete_option('drdt-dark-status');
        }
    ...
    */
    public function hidden_admin_notices(){
        ...
        if( in_array($screen->id, [ 'settings_page_droit-dark-settings', 'settings_page_droit-dark-active']) ){
    ...
    */
    public function settings_page(){
        ...
        $dataLicense = '';
        if( class_exists('\DroitDark\Includes\Dtdr_Features') ){
            $status = Dtdr_Features::_instance()->_get_action();
            $key_data = get_option('__validate_author_dtdrdark_keys__','');
            $dataLicense = Dtdr_Features::_instance()->get_pro($key_data);
        }
    ...
    */
    ...
    public function admin_enqueue(){
        ...
        $screen = get_current_screen();
        if( in_array($screen->id, [ 'settings_page_droit-dark-settings']) ){
    ...
    */
    ...
    public function drdt_activate(array $parmas){
        ...
        if( isset($output->status) && $output->status=='success' ){
            ...
            Dtdr_Features::_instance()->save_pro($key,$output);
        }
        return $output;
    }
